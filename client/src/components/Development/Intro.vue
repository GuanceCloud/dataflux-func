...
API authentication for Auth Links and Batches: 用於授權鏈接和批處理的 API 認證
Add selection to next find match: 將下一個查找匹配項添加到選擇
Allow Python functions be called as HTTP APIs: 允許 Python 函數作為 HTTP API 調用
...
API authentication for Auth Links and Batches: 用於授權連結和批處理的 API 認證
Add selection to next find match: 將下一個查詢匹配項新增到選擇
Allow Python functions be called as HTTP APIs: 允許 Python 函式作為 HTTP API 呼叫
