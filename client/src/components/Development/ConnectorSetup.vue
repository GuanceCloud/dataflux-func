...
API Key: API Key
API Key ID: API Key ID
API Key here is always required: 每次修改都必須重新輸入 API Key
Add Connector: 添加連接器
Add Topic / Handler: 添加主題 / 處理函數
Are you sure you want to delete the Connector?: 是否確認刪除此連接器？
Auth Type: 認證類型
Cannot find the Guance Node you need?: 找不到需要的觀測雲節點？
Cannot not starts with a number: 不得以數字開頭
Charset: 編碼
Client ID: 客户端 ID
Compatibility: 兼容性
Connector Development Doc: 連接器開發文檔
Connector created: 連接器已創建
Connector deleted: 連接器已刪除
Connector saved: 連接器已保存
Content: 內容
Current consumption rate: 當前消費速度
Database: 數據庫
Func Return Value: 函數返回值
Group ID: 分組 ID
Guance Node: 觀測雲節點
Handler Func: 處理函數
Host: 主機
Last Consumed: 最後消費
Learn more about subscribing using Connector: 瞭解通過連接器進行訂閲
Message: 消息
Multi Sub: 多訂閲器
Name in Guance: 觀測雲中名稱
No Recent Message: 無近期消息
Node SDK used in the Subscriber: 本訂閲器所使用的 Node SDK
Only HTTP and HTTPS are allowed: 協議只能為HTTP或HTTPS
Only alphabets, numbers and underscore are allowed: 只能包含大小寫英文、數字及下劃線
Only integer between 1 and 65535 are allowed: 主機端口範圍為 1-65535
OpenAPI URL: OpenAPI 地址
OpenWay URL: OpenWay 地址
Password: 密碼
Password here is always required when the Connector requires password to connect: 如連接器需要密碼，則每次修改都必須重新輸入密碼
Please input API Key: 請輸入 API Key
Please input API Key ID: 請輸入 API Key ID
Please input Access Key: 請輸入Access Key
Please input Connector type: 請選擇連接器類型
Please input ID: 請輸入 ID
Please input OpenAPI URL: 請輸入 OpenAPI 地址
Please input OpenWay URL: 請輸入 OpenWay 地址
Please input Secret Key: 請輸入Secret Key
Please input Websocket URL: 請輸入 WebSocket 地址
Please input auth type: 請輸入認證方式
Please input charset: 請輸入字符集
Please input client ID: 請輸入客户端 ID
Please input database: 請輸入數據庫名
Please input host: 請輸入主機地址
Please input password: 請輸入密碼
Please input port: 請輸入主機端口
Please input servers: 請輸入服務器列表
Please input source: 請輸入連接器名稱
Please input topic: 請輸入訂閲主題
Please input user: 請輸入用户名
Please select Guance Node: 請選擇觀測雲節點
Please select HTTP protocol: 請選擇HTTP協議
Please select handler Func: 請選擇處理函數
Port: 端口
Protocol: 協議
Python SDK used in the Connector: 本連接器所使用的 Python SDK
SASL Mechanisms: SASL 機制
Save without connection test: 保存（忽略連通性測試）
Security Protocol: 安全協議
Servers: 服務器列表
Servers to connect (e.g. host1:80,host2:81): 連接地址列表，如：host1:80,host2:81
Setup Connector: 配置連接器
Should start with http:// or https://: 必須以 http:// 或 https:// 開頭
Source: 源
Sub Offset: 訂閲 Offset
Test connection: 測試連通性
This Title will also be displayed in Guance: 這個標題同時也會展示在觀測雲中
This is a built-in Connector, please contact the admin to change the config: 當前連接器為內置連接器，請聯繫管理員調整集羣配置
Topic: 主題
Topic Handler is disabled: 主題訂閲處理已禁用
Topic/Handler: 主題 / 處理函數
Traceback: 調用堆棧
User: 用户
WebSocket URL: WebSocket 地址
messageRate: '{n} 條/分鐘'
...
API Key here is always required: 每次修改都必須重新輸入 API Key
Add Connector: 新增聯結器
Add Topic / Handler: 新增主題 / 處理函式
Are you sure you want to delete the Connector?: 是否確認刪除此聯結器？
Auth Type: 認證型別
Cannot find the Guance Node you need?: 找不到需要的觀測雲節點？
Cannot not starts with a number: 不得以數字開頭
Charset: 編碼
Client ID: 客戶端 ID
Compatibility: 相容性
Connector Development Doc: 聯結器開發文件
Connector created: 聯結器已建立
Connector deleted: 聯結器已刪除
Connector saved: 聯結器已儲存
Content: 內容
Current consumption rate: 當前消費速度
Database: 資料庫
Func Return Value: 函式返回值
Group ID: 分組 ID
Guance Node: 觀測雲節點
Handler Func: 處理函式
Host: 主機
Last Consumed: 最後消費
Learn more about subscribing using Connector: 瞭解透過聯結器進行訂閱
Message: 訊息
Multi Sub: 多訂閱器
Name in Guance: 觀測雲中名稱
No Recent Message: 無近期訊息
Node SDK used in the Subscriber: 本訂閱器所使用的 Node SDK
Only HTTP and HTTPS are allowed: 協議只能為HTTP或HTTPS
Only alphabets, numbers and underscore are allowed: 只能包含大小寫英文、數字及下劃線
Only integer between 1 and 65535 are allowed: 主機埠範圍為 1-65535
OpenAPI URL: OpenAPI 地址
OpenWay URL: OpenWay 地址
Password: 密碼
Password here is always required when the Connector requires password to connect: 如聯結器需要密碼，則每次修改都必須重新輸入密碼
Please input API Key: 請輸入 API Key
Please input API Key ID: 請輸入 API Key ID
Please input Access Key: 請輸入Access Key
Please input Connector type: 請選擇聯結器型別
Please input ID: 請輸入 ID
Please input OpenAPI URL: 請輸入 OpenAPI 地址
Please input OpenWay URL: 請輸入 OpenWay 地址
Please input Secret Key: 請輸入Secret Key
...
Please input auth type: 請輸入認證方式
Please input charset: 請輸入字符集
Please input client ID: 請輸入客戶端 ID
Please input database: 請輸入資料庫名
Please input host: 請輸入主機地址
Please input password: 請輸入密碼
Please input port: 請輸入主機埠
Please input servers: 請輸入伺服器列表
Please input source: 請輸入聯結器名稱
Please input topic: 請輸入訂閱主題
Please input user: 請輸入使用者名稱
Please select Guance Node: 請選擇觀測雲節點
Please select HTTP protocol: 請選擇HTTP協議
Please select handler Func: 請選擇處理函式
Port: 埠
Protocol: 協議
Python SDK used in the Connector: 本聯結器所使用的 Python SDK
SASL Mechanisms: SASL 機制
Save without connection test: 儲存（忽略連通性測試）
Security Protocol: 安全協議
Servers: 伺服器列表
Servers to connect (e.g. host1:80,host2:81): 連線地址列表，如：host1:80,host2:81
Setup Connector: 配置聯結器
Should start with http:// or https://: 必須以 http:// 或 https:// 開頭
Source: 源
Sub Offset: 訂閱 Offset
Test connection: 測試連通性
This Title will also be displayed in Guance: 這個標題同時也會展示在觀測雲中
This is a built-in Connector, please contact the admin to change the config: 當前聯結器為內建聯結器，請聯絡管理員調整叢集配置
Topic: 主題
Topic Handler is disabled: 主題訂閱處理已禁用
Topic/Handler: 主題 / 處理函式
Traceback: 呼叫堆疊
User: 使用者
WebSocket URL: WebSocket 地址
messageRate: '{n} 條/分鐘'
