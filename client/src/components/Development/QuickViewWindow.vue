...
Drag to place: 調整位置
The Quick View window is only shown when the Script Lib is active, drag and drop the title bar to move the position: 快速查看窗口僅在腳本庫激活時顯示，拖拽標題欄可以移動位置
</i18n>
<i18n locale="zh-TW" lang="yaml">
Drag to place: 調整位置
The Quick View window is only shown when the Script Lib is active, drag and drop the title bar to move the position: 快速檢視視窗僅在指令碼庫啟用時顯示，拖拽標題欄可以移動位置
</i18n>
