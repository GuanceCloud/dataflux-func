...
Exporting Script Sets for backup or sharing Script Sets: 使用腳本集導出功能備份或分享腳本集
No Script Set has ever been exported: 從未導出過任何腳本集
</i18n>
<i18n locale="zh-TW" lang="yaml">
Exporting Script Sets for backup or sharing Script Sets: 使用指令碼集匯出功能備份或分享指令碼集
No Script Set has ever been exported: 從未匯出過任何指令碼集
</i18n>
