...
Are you sure you want to disable the File Service?: 是否確認禁用此文件服務？
Expose folders in the Resource as File Services to allow external systems to access files directly: 將資源目錄下的文件夾創建為文件服務，即可在系統外部直接訪問文件
File Service deleted: 文件服務已刪除
File Service disabled: 文件服務已禁用
File Service enabled: 文件服務已啓用
No File Service has ever been added: 從未添加過任何文件服務
Root: 根目錄
</i18n>
<i18n locale="zh-TW" lang="yaml">
Are you sure you want to delete the File Service?: 是否確認刪除此檔案服務？
Are you sure you want to disable the File Service?: 是否確認禁用此檔案服務？
Expose folders in the Resource as File Services to allow external systems to access files directly: 將資源目錄下的資料夾建立為檔案服務，即可在系統外部直接訪問檔案
File Service deleted: 檔案服務已刪除
File Service disabled: 檔案服務已禁用
File Service enabled: 檔案服務已啟用
No File Service has ever been added: 從未新增過任何檔案服務
Root: 根目錄
</i18n>
