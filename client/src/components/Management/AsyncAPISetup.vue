        ...
        <div class="setup-form">
          <el-form ref="form" label-width="135px" :model="form" :rules="formRules">
            ...
            <el-form-item :label="$t('Task Record')">
              ...
              <el-link class="task-record-limit-clear" type="primary" @click.stop="form.taskRecordLimit = $store.getters.SYSTEM_INFO('_TASK_RECORD_FUNC_LIMIT_ASYNC_API')">{{ $t('Restore Default') }}</el-link>
            </el-form-item>
...
export default {
  ...
  methods: {
    async loadData(id) {
      if (!id) {
        ...
        if (this.T.isNothing(nextForm.taskRecordLimit)) {
          nextForm.taskRecordLimit = this.$store.getters.SYSTEM_INFO('_TASK_RECORD_FUNC_LIMIT_ASYNC_API')
        }
    ...
    async addData() {
      ...
      let opt = {
        body : { data: _formData },
        alert: { okMessage: this.$t('Async API created') },
      };
    ...
    async modifyData() {
      ...
      let opt = {
        ...
        body  : { data: _formData },
        alert : { okMessage: this.$t('Async API saved') },
      };
