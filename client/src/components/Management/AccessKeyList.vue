...
Access Key deleted: Access Key 已刪除
Add Access Key to allow external systems to call the Open APIs of this system: 添加 Access Key，允許外部系統調用本系統的 Open API
Are you sure you want to delete the Access Key?: 是否確認刪除此 Access Key？
No Access Key has ever been added: 從未添加過任何 Access Key
</i18n>
<i18n locale="zh-TW" lang="yaml">
Access Key deleted: Access Key 已刪除
Add Access Key to allow external systems to call the Open APIs of this system: 新增 Access Key，允許外部系統呼叫本系統的 Open API
Are you sure you want to delete the Access Key?: 是否確認刪除此 Access Key？
No Access Key has ever been added: 從未新增過任何 Access Key
</i18n>
