...
you must first create an Sync API for the Python function and access the Python function through the Sync API.: 必须先为 Python 函数创建同步 API ，通过同步 API 访问 Python 函数
</i18n>
...
you must first create an Sync API for the Python function and access the Python function through the Sync API.: 必須先為 Python 函數創建同步 API ，通過同步 API 訪問 Python 函數
</i18n>
...
lastStarted: '{t}執行'
lastSucceeded: '{t}執行成功'
you must first create an Sync API for the Python function and access the Python function through the Sync API.: 必須先為 Python 函式建立同步 API ，透過同步 API 訪問 Python 函式
</i18n>
