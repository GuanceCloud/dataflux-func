...
? After recovery, the entire Script Lib will be reset to the state at the time the Recover Point was created and will take effect immediately.<hr class="br">Are you sure you want to recover?
: 執行恢復後，整個腳本庫將重置到還原點創建時的狀態且立即生效。<hr class="br">是否確認恢復？
Create Recover Point: 創建還原點
No Recover Point has ever been created: 從未創建過任何還原點
Recover Points can also be created manually.: 也可以手動創建腳本庫還原點。
Script Lib Recover: 腳本庫還原
Script Lib recovered: 腳本庫已還原
System automatically creates Script Lib Recover Points before importing, installing Script Sets.: 在導入、安裝腳本集前，系統會自動創建還原點。
</i18n>
<i18n locale="zh-TW" lang="yaml">
? After recovery, the entire Script Lib will be reset to the state at the time the Recover Point was created and will take effect immediately.<hr class="br">Are you sure you want to recover?
: 執行恢復後，整個指令碼庫將重置到還原點建立時的狀態且立即生效。<hr class="br">是否確認恢復？
Create Recover Point: 建立還原點
No Recover Point has ever been created: 從未建立過任何還原點
Recover Points can also be created manually.: 也可以手動建立指令碼庫還原點。
Script Lib Recover: 指令碼庫還原
Script Lib recovered: 指令碼庫已還原
System automatically creates Script Lib Recover Points before importing, installing Script Sets.: 在匯入、安裝指令碼集前，系統會自動建立還原點。
</i18n>
