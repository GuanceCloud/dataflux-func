...
When the Work Queue length reaches the limit, Crontab Schedules will stop generating new tasks: 当工作队列长度达到限制时，Crontab 计划将停止产生新任务
...
Up Time MAX: 最長已運行
Up Time MIN: 最短已運行
When the Work Queue length reaches the limit, Crontab Schedules will stop generating new tasks: 當工作隊列長度達到限制時，Crontab 計劃將停止產生新任務
Worker: 工作單元
Worker Queue: 工作隊列
generalCount: '{n} 個'
...
Up Time MAX: 最長已執行
Up Time MIN: 最短已執行
When the Work Queue length reaches the limit, Crontab Schedules will stop generating new tasks: 當工作佇列長度達到限制時，Crontab 計劃將停止產生新任務
Worker: 工作單元
Worker Queue: 工作佇列
generalCount: '{n} 個'
recentOperationCount: 最近 {n} 條
            ...
            <table>
              <tbody>
                ...
                <tr v-if="q.workerQueueLimit" class="text-main">
                  <td>
                    <el-tooltip effect="dark" :content="$t('When the Work Queue length reaches the limit, Crontab Schedules will stop generating new tasks')" placement="bottom">
