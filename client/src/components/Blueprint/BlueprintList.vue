...
Add Blueprint to deploy data processing flow in a visualization way: 添加藍圖，使用可視化方式部署數據處理流程
Are you sure you want to delete the Blueprint?: 是否確認刪除此藍圖？
Blueprint deleted: 藍圖已刪除
No Blueprint has ever been added: 從未添加過任何藍圖
</i18n>
<i18n locale="zh-TW" lang="yaml">
Add Blueprint to deploy data processing flow in a visualization way: 新增藍圖，使用視覺化方式部署資料處理流程
Are you sure you want to delete the Blueprint?: 是否確認刪除此藍圖？
Blueprint deleted: 藍圖已刪除
No Blueprint has ever been added: 從未新增過任何藍圖
</i18n>
