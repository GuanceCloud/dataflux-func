...
Cache is cleared: 緩存已清除
Clear: 清除
Clear Cache: 清除緩存
Code Editor Setting: 代碼編輯器配置
Expanded items in Code Editor Aside: 編輯器側欄中當前已展開的欄目
Font size, line height: 文字大小、行距
If you got trouble with UI or Code Editor, please try to clear cache: 如果界面、代碼編輯器等存在問題，可嘗試清除緩存來解決
Including: 包括
Notice messages or dialogs: 提示信息及對話框
Page will be refreshed, and config will reload from server: 即將刷新頁面，並從服務器重新加載系統配置
Page will refresh after clearing this content: 清除本項目會刷新頁面
Position of Aside separator, output box: 編輯器當前拖動的的編輯器側欄、腳本輸出欄位置
Position of Quick View Panel: 快速查看面板當前位置
Position of Simple Debug Panel: 簡易調試面板當前位置
Position of scroll in Management: 管理界面列表當前滾動所處位置
Search history: 搜索歷史
Selected Func, Highlighted line or error line: 編輯器當前選擇的函數、高亮已選擇函數所在行、高亮錯誤行
Selected UI theme: 已選擇的主題
System Info loaded from server: 從服務器加載的系統信息
UI Status: 頁面狀態
</i18n>
<i18n locale="zh-TW" lang="yaml">
Cache is cleared: 快取已清除
Clear: 清除
Clear Cache: 清除快取
Code Editor Setting: 程式碼編輯器配置
Expanded items in Code Editor Aside: 編輯器側欄中當前已展開的欄目
Font size, line height: 文字大小、行距
If you got trouble with UI or Code Editor, please try to clear cache: 如果介面、程式碼編輯器等存在問題，可嘗試清除快取來解決
Including: 包括
Notice messages or dialogs: 提示資訊及對話方塊
Page will be refreshed, and config will reload from server: 即將重新整理頁面，並從伺服器重新載入系統配置
Page will refresh after clearing this content: 清除本專案會重新整理頁面
Position of Aside separator, output box: 編輯器當前拖動的的編輯器側欄、指令碼輸出欄位置
Position of Quick View Panel: 快速檢視面板當前位置
Position of Simple Debug Panel: 簡易除錯面板當前位置
Position of scroll in Management: 管理介面列表當前滾動所處位置
Search history: 搜尋歷史
Selected Func, Highlighted line or error line: 編輯器當前選擇的函式、高亮已選擇函式所在行、高亮錯誤行
Selected UI theme: 已選擇的主題
System Info loaded from server: 從伺服器載入的系統資訊
UI Status: 頁面狀態
</i18n>
