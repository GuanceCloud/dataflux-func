...
Length of password should longer than 6: 密碼至少6位
New password: 新密碼
New password not matches: 兩次輸入密碼不一致
Old password: 舊密碼
Password changed: 密碼已修改
Password should contains uppercase, lowercase alphabet and number: 密碼必須同時包含大寫英文、小寫英文和數字
Please confirm new password: 請再輸入一遍新密碼
Please input captcha: 請輸入驗證碼
Please input new password: 請輸入新密碼
Please input old password: 請輸入舊密碼
User not found: 當前用户不存在
You are signed in as a integrated user, please change your password in the origin system: 當前登錄用户為集成登錄用户，修改密碼請前往原系統進行操作
</i18n>
...
Please input new password: 請輸入新密碼
Please input old password: 請輸入舊密碼
User not found: 當前使用者不存在
You are signed in as a integrated user, please change your password in the origin system: 當前登入使用者為整合登入使用者，修改密碼請前往原系統進行操作
</i18n>
