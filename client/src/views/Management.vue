...
renameTipSyncAPI : 'Called "Auth Link" in the old version. We have adjusted the naming for ease of understanding'
renameTipAsyncAPI: 'Called "Batch" in the old version. We have adjusted the naming for ease of understanding'
renameTipCronJob : 'Called "Crontab Config" in the old version. We have adjusted the naming for ease of understanding'
</i18n>

<i18n locale="zh-CN" lang="yaml">
renameTipSyncAPI : 在旧版中称为「授权链接」。为了便于理解，我们调整了命名
renameTipAsyncAPI: 在旧版中称为「批处理」。为了便于理解，我们调整了命名
renameTipCronJob : 在旧版中称为「自动触发配置」。为了便于理解，我们调整了命名
</i18n>

<!-- Generated by OpenCC START -->
<i18n locale="zh-HK" lang="yaml">
renameTipAsyncAPI: 在舊版中稱為「批處理」。為了便於理解，我們調整了命名
renameTipCronJob: 在舊版中稱為「自動觸發配置」。為了便於理解，我們調整了命名
renameTipSyncAPI: 在舊版中稱為「授權鏈接」。為了便於理解，我們調整了命名
</i18n>
<i18n locale="zh-TW" lang="yaml">
renameTipAsyncAPI: 在舊版中稱為「批處理」。為了便於理解，我們調整了命名
renameTipCronJob: 在舊版中稱為「自動觸發配置」。為了便於理解，我們調整了命名
renameTipSyncAPI: 在舊版中稱為「授權連結」。為了便於理解，我們調整了命名
</i18n>
      ...
      <div class="aside">
        <div class="aside-content">
          <el-menu
            ...
            <el-tooltip effect="dark" :content="$t('renameTipCronJob')" placement="right">
              <el-menu-item index="/management/cron-job-list">
                <span>
            ...
            <el-menu-item v-if="$store.getters.isExperimentalFeatureEnabled('FuncAPIDoc')"
              class="indent-menu" :index="`${T.getBaseURL()}/#/func-api-doc`">
              <span>
                <i class="fa fa-fw fa-link"></i>
                {{ $t('Func API Doc') }}
              </span>
