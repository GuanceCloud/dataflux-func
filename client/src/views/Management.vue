...
renameTipCronJob : 'I.e. "Crontab Config" in the previous version. We have adjusted the naming for ease of understanding'
</i18n>

<i18n locale="zh-CN" lang="yaml">
renameTipSyncAPI : 即之前版本中的的「授权链接」。为了便于理解，我们调整了命名
renameTipAsyncAPI: 即之前版本中的的「批处理」。为了便于理解，我们调整了命名
renameTipCronJob : 即之前版本中的的「自动触发配置」。为了便于理解，我们调整了命名
</i18n>

<!-- Generated by OpenCC START -->
<i18n locale="zh-HK" lang="yaml">
renameTipAsyncAPI: 即之前版本中的的「批處理」。為了便於理解，我們調整了命名
renameTipCronJob: 即之前版本中的的「自動觸發配置」。為了便於理解，我們調整了命名
renameTipSyncAPI: 即之前版本中的的「授權鏈接」。為了便於理解，我們調整了命名
</i18n>
<i18n locale="zh-TW" lang="yaml">
renameTipAsyncAPI: 即之前版本中的的「批處理」。為了便於理解，我們調整了命名
renameTipCronJob: 即之前版本中的的「自動觸發配置」。為了便於理解，我們調整了命名
renameTipSyncAPI: 即之前版本中的的「授權連結」。為了便於理解，我們調整了命名
</i18n>
