...
function genBaseCode(nodeList, linkList) {
  ...
  codeLines.push(`'''`);
  codeLines.push(`This Script is auto generated by the Blueprint Mode`);
  codeLines.push(`You can change the code by your self,`);
  codeLines.push(`but all your changes will lose after you deployed the Blueprint again.`);
  codeLines.push(`'''`);
