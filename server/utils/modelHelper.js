 ...
 * @param  {String=null} options.template
 * @param  {JSON=null}   options.pageData
 * @return {Function}
 */
CRUDHandler.prototype.createListPage = function(options) {
  var self = this;
  return function(req, res, next) {
    options = options || {}
    ...
    async.series([
      ...
      res.locals.render(template, pageData);
    });
  };
};

/**
 * Create a `data/:id` page
 *
 * @param  {Object=null} options
 * @param  {String=null} options.template
 * @param  {JSON=null}   options.pageData
 * @return {Function}
 */
CRUDHandler.prototype.createViewPage = function(options) {
  var self = this;
  return function(req, res, next) {
    options = options || {}
 ...
 * @return {Function}
 */
CRUDHandler.prototype.createAddPage = function(options) {
  var self = this;
  return function(req, res, next) {
    options = options || {}
 ...
 * @return {Function}
 */
CRUDHandler.prototype.createModifyPage = function(options) {
  var self = this;
  return function(req, res, next) {
    options = options || {}
