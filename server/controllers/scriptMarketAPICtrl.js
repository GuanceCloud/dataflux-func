...
function _isAutoGenerated(text) {
...
function _getDefaultScriptMarketReadmeContent(scriptMarket, scriptSets) {
  ...
  if (!toolkit.isNothing(scriptSets)) {
    ...
    content += '\n\n' + _getMarkdownTable(_table);
  }

  return _addAutoGeneratedInfo(content, 'markdown');
};
      ...
      function(asyncCallback) {
        try {
          ...
          pushContent.scriptSets.forEach(function(scriptSet) {
            ...
            // 写入 README
            var scriptSetReadmeData     = _getDefaultScriptSetReadmeContent(scriptSet);
            ...
            metaData.scripts.forEach(function(script) {
              ...
              var specialType = SPECIAL_FILE_TYPE_MAP[scriptName];
