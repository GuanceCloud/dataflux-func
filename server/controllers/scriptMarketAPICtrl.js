  ...
  async.series([
    ...
    function(asyncCallback) {
      async.eachSeries(scriptMarkets, function(scriptMarket, eachCallback) {
        // 获取 META 信息
        scriptMarket.meta = SCRIPT_MARKET_LIST_ALL_META_DATA_FUNC_MAP[scriptMarket.type](scriptMarket);
        if (Array.isArray(scriptMarket.meta)) {
          scriptMarket.meta.forEach(function(m) {
            m.md5 = toolkit.getMD5(sortedJSON.sortify(m || {}, { stringify: true, sortArray: false}));
          });
        }
