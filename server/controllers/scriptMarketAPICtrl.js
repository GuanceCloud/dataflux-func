...
function _prepareGitRepo(locals, git, callback) {
  var prevCommitId = null;

  var lockKey     = toolkit.getCacheKey('lock', 'scriptMarketGitOperation');
  var lockValue   = Date.now().toString();
  var lockAge     = CONFIG._SCRIPT_MARKET_GIT_OPERATION_LOCK_AGE;
  var lockWaitAge = CONFIG._SCRIPT_MARKET_GIT_OPERATION_LOCK_WAIT_AGE;
  async.series([
    // 上锁
...
function _syncToGitRepo(locals, git, author, note, callback) {
  var prevCommitId = null;
...
var SCRIPT_MARKET_FETCH_FUNC_MAP = {
  git: function(locals, scriptMarket, callback) {
    ...
    _prepareGitRepo(locals, git, callback);
  },
...
var SCRIPT_MARKET_LIST_SCRIPT_SETS_FUNC_MAP = {
  git: function(locals, scriptMarket, callback) {
    ...
    async.series([
      // 准备 Git 库
      function(asyncCallback) {
        _prepareGitRepo(locals, git, asyncCallback);
      },
      function(asyncCallback) {
        try {
...
var SCRIPT_MARKET_SET_ADMIN_FUNC_MAP = {
  git: function(locals, scriptMarket, callback) {
    ...
    async.series([
      ...
      // 同步至 Git
      function(asyncCallback) {
        _syncToGitRepo(locals, git, null, 'Set Token', asyncCallback);
      },
    ], callback);
  },
  aliyun_oss: function(locals, scriptMarket, callback) {
...
var SCRIPT_MARKET_UNSET_ADMIN_FUNC_MAP = {
  git: function(locals, scriptMarket, callback) {
    ...
    async.series([
      ...
      // 同步至 Git
      function(asyncCallback) {
        _syncToGitRepo(locals, git, null, 'Unset Token', asyncCallback);
      },
    ], callback);
  },
  aliyun_oss: function(locals, scriptMarket, callback) {
...
var SCRIPT_MARKET_PUSH_FUNC_MAP = {
  git: function(locals, scriptMarket, pushContent, author, note, callback) {
    ...
    async.series([
      ...
      // 同步至 Git
      function(asyncCallback) {
        _syncToGitRepo(locals, git, author, note, asyncCallback);
      },
    ], callback);
  },
...
exports.add = function(req, res, next) {
  ...
  async.series([
    ...
    // 尝试获取所有权
    function(asyncCallback) {
      SCRIPT_MARKET_SET_ADMIN_FUNC_MAP[data.type](res.locals, data, function(err) {
        // 出错表示无法获取所有权，跳过
...
exports.modify = function(req, res, next) {
  ...
  async.series([
    ...
    function(asyncCallback) {
      ...
      SCRIPT_MARKET_INIT_FUNC_MAP[scriptMarket.type](res.locals, data, asyncCallback);
    },
    // 数据入库
    function(asyncCallback) {
  ...
  async.series([
    ...
    function(asyncCallback) {
      scriptMarketModel.getWithCheck(id, null, function(err, dbRes) {
        ...
        // 放弃所有权（忽略错误）
        SCRIPT_MARKET_UNSET_ADMIN_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, function(err) {
          // 出错表示无法放弃所有权，忽略
          if (err) res.locals.logger.error(err.toString());
        });
...
exports.listScriptSets = function(req, res, next) {
  ...
  async.series([
    ...
    // 列出脚本市场脚本集
    function(asyncCallback) {
      SCRIPT_MARKET_LIST_SCRIPT_SETS_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, function(err, _scriptSets) {
        if (err) return asyncCallback(err);
...
exports.setAdmin = function(req, res, next) {
  ...
  async.series([
    ...
    // 获取所有权
    function(asyncCallback) {
      SCRIPT_MARKET_SET_ADMIN_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, asyncCallback);
    },
  ], function(err) {
    if (err) return next(err);
...
exports.unsetAdmin = function(req, res, next) {
  ...
  async.series([
    ...
    // 放弃所有权
    function(asyncCallback) {
      SCRIPT_MARKET_UNSET_ADMIN_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, asyncCallback);
    },
  ], function(err) {
    if (err) return next(err);
...
exports.publish = function(req, res, next) {
  ...
  async.series([
    ...
    // 推送数据
    function(asyncCallback) {
      SCRIPT_MARKET_PUSH_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, pushContent, author, note, asyncCallback);
    },
  ], function(err) {
    if (err) return next(err);
...
exports.install = function(req, res, next) {
  ...
  async.series([
    ...
    // 获取拉取数据数据
    function(asyncCallback) {
      SCRIPT_MARKET_PULL_FUNC_MAP[scriptMarket.type](res.locals, scriptMarket, scriptSetIds, function(err, _pullContent) {
        if (err) return asyncCallback(err);
