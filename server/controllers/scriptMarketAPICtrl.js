...
exports.install = function(req, res, next) {
  ...
  var startupCrontabScheduleIds           = [];
  var startupScriptCrontabScheduleFuncMap = {};
  ...
  async.series([
    ...
    function(asyncCallback) {
      ...
      funcModel.list(opt, function(err, dbRes) {
        ...
        dbRes.forEach(function(d) {
          if (startupScriptCrontabScheduleFuncMap[d.scriptId]) return;
          startupScriptCrontabScheduleFuncMap[d.scriptId] = d;
        });
    ...
    function(asyncCallback) {
      ...
      crontabScheduleModel.list(opt, function(err, dbRes) {
        ...
        dbRes.forEach(function(d) {
          startupCrontabScheduleIds.push(d.id);
        })
    ...
    var ret = toolkit.initRet({
      ...
      startupCrontabScheduleIds          : startupCrontabScheduleIds,
      startupScriptCrontabScheduleFuncMap: startupScriptCrontabScheduleFuncMap,
    });
    return res.locals.sendJSON(ret);
  });
};
