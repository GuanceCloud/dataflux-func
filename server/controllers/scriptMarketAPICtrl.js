...
var OSS_UTIL_CMD = path.join(__dirname, `../../tools/${process.arch === 'x64' ? 'ossutil64' : 'ossutilarm64'}`);
  ...
  switch(scriptMarket.type) {
    ...
    case 'aliyun_oss':
      ...
      var localAbsPath = path.join(
          ...
          endpointObj.hostname,
          scriptMarket.configJSON.bucket,
          scriptMarket.configJSON.folder.replace('/', '-'));
      return localAbsPath;
  }
};
