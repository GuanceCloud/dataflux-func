...
exports.systemInfo = function(req, res, next) {
  var systemInfo = {
    ...
    _TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_SYNC_API        : CONFIG._TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_SYNC_API,
    _TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_CRONTAB_SCHEDULE: CONFIG._TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_CRONTAB_SCHEDULE,
    _TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_ASYNC_API       : CONFIG._TASK_RECORD_FUNC_LIMIT_BY_ORIGIN_ASYNC_API,
