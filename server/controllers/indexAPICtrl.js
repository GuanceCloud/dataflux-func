...
exports.systemInfo = function(req, res, next) {
  var systemInfo = {
    ...
    _TASK_RECORD_DEFAULT_LIMIT_AUTH_LINK: CONFIG._TASK_RECORD_DEFAULT_LIMIT_AUTH_LINK,
    _TASK_RECORD_DEFAULT_LIMIT_CRONTAB  : CONFIG._TASK_RECORD_DEFAULT_LIMIT_CRONTAB,
    _TASK_RECORD_DEFAULT_LIMIT_BATCH    : CONFIG._TASK_RECORD_DEFAULT_LIMIT_BATCH,
